...
public class ScoreVO {
	...
	public String toString() {
		return "ScoreVO [mem_id=" + mem_id + ", mem_name=" + mem_name + ", comprehension_score=" + comprehension_score
				+ ", teacherquestion_no=" + teacherquestion_no + ", comprehension_replycnt=" + comprehension_replycnt
				+ "]";
	}
