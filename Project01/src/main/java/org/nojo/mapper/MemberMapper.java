...
public interface MemberMapper {
	...
	//회원가입
	@Insert("insert into tbl_member(mem_id, mem_name, mem_pw, mem_email, mem_tel, mem_gb, mem_photo) values(#{mem_id}, #{mem_name}, #{mem_pw}, #{mem_email}, #{mem_tel}, #{mem_gb},#{mem_photo})")
